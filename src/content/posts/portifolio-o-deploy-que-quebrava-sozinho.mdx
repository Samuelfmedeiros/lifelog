...
### Fix 1: alinhar o packageManager
...
### Fix 2: matar o `node-linker=hoisted`
...
<Terminal
  lines={[
  { cmd: 'git show COMMIT_REF', output: 'packageManager pnpm@9.12.3 → 10.34.5 + lock regenerado' },
  { cmd: 'git show COMMIT_REF', output: 'remove node-linker=hoisted — ERR_PNPM_EEXIST no @parcel/watcher-wasm' },
