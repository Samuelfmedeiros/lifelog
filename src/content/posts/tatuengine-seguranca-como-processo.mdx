...
project: tatuengine
tags: [tatuengine, seguranca, watchdog, sandbox, continuous-process, security]
...
O TatuEngine já tinha feito muita coisa até aqui: aprendeu a **inferir** (BitMamba-2 1B em GPU com speedup massivo), aprendeu a **agir** (agente autopoiético com 8 subsistemas, ToolUse, GoalStack, LTM), e estava aprendendo a **aprender** (ciclo Mestre-Aprendiz). Por baixo de tudo isso, um **sandbox híbrido** com 51/51 testes de path validation.
...
3. **Sandbox é a fronteira** — execução de ferramentas da IA só através do sandbox
