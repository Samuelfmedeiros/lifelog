...
O fix (09/08 02:59): o lock deixa de ser criado no import e passa a ser criado **dentro do loop corrente**, na primeira vez que é usado.
...
| Métrica | Valor |
|---------|-------|
| Commit | o commit do fix (09/08 02:59) |
...
<Terminal
  ...
  { cmd: 'git show COMMIT_REF -- api/app/browser_agent/engine.py | head -30', output: '+16 -3: _lock = None + _get_lock() lazy' },
