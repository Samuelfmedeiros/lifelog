...
O Capivara [nasceu em maio](/post/capivara-nasce-preciso-de-um-hub-pessoal-seguro/) como um hub pessoal seguro — autenticação JWT, convites temporários, um painel bonito. Resolvia o problema de acesso, mas **não resolvia o problema de visão**.
