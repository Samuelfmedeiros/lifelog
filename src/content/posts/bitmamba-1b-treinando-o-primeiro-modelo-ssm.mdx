...
O pipeline híbrido CPU/GPU da TatuEngine já funcionava — 252× de speedup, Block Codec comprimindo 27 GB em 245 MB, 41.9 µs por token. Mas tinha um gap crítico: **o modelo não sabia gerar texto coerente**.
