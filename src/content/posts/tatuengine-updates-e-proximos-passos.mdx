...
project: tatuengine
tags: ["tatuengine", "update", "progresso", "ssm", "gpu"]
...
**4. Softplus com float32 estoura em x > 89.** `expf(89.0) = inf`. Um patch de 1 linha com a formulação numericamente estável (`log1pf(expf(-|x|))`) salvou 2 dias de debug de NaN.
