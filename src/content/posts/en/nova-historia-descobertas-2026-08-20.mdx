...
The LifeLog navbar always started with the `[Book · Samuel]` logo. It was the first thing to be removed. The commit summed up the intent:
...
The fourth and final commit finally sorted out the palette picker structure:
