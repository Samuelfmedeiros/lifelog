...
**4. Softplus overflows in float32 near the type limit.** `exp()` becomes `inf`, backward spreads NaN. A 1-line patch with the numerically stable formulation fixed it.
