...
In late July, LifeLog also gained **Open Design** — a formal design system with DESIGN.md (16KB), CSS tokens, and craft rules. Every color palette, every component, every transition documented in a design contract that the site itself consumes.
