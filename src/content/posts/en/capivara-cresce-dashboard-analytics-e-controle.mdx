...
Capivara [was born in May](/post/capivara-nasce-preciso-de-um-hub-pessoal-seguro/) as a secure personal hub — JWT authentication, temporary invites, a nice dashboard. It solved the access problem, but **it didn't solve the visibility problem**.
