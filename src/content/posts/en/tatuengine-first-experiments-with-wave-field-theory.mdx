...
The problem appeared quickly: **1 billion parameters in float32 = 36 GB of lenses**. Each weight became 3 vertices × 3 floats + 3 optical property floats — 36 bytes per weight. For 1B parameters, 36 GB — no chance of fitting in consumer GPU VRAM.
...
Instead of 1 lens per weight (36 bytes), a **compact block** fit in 288 bytes:
