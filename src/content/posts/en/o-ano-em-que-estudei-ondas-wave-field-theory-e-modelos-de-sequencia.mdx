...
project: estudos
tags: [estudos, wave-field-theory, mamba, ssm, bitmamba, ollama, num-ctx, studies]
...
| Mamba SSM (study + implementation) | 1.4B model, µs/tok inference | Functional GPU pipeline |
