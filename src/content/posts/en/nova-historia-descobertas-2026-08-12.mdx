...
project: descobertas
tags: [descobertas, git, github, lfs, tatuengine, debugging]
...
remote: error: File <binary model weights> is 2147.48 MB; this exceeds GitHub's file size limit of 100 MB
```
