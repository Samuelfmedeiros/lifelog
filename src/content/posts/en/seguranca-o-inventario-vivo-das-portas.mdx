...
project: seguranca
tags: [seguranca, watchdog, ports, bindings, hardening, inventory, automation, security]
...
<Terminal
  lines={[
  { cmd: 'python3 security-watchdog.py', output: 'Port inventory (N ports) — all mapped against known inventory' },
